...
public class AlgoBuy implements IStrategy {
            ...
            if (pendingOrder != null) {
                ...
                if(pendingOrder.getState() == IOrder.State.FILLED) {
                    ...
                    if (order.isLong()) {
                        ...
                        pendingOrder = submitOrder(OrderCommand.SELL, instrument, order.getStopLossPrice());

                    } else {
                        nextLong = false; // switch side

                        pendingOrder = submitOrder(OrderCommand.BUY, instrument, order.getStopLossPrice());
                    }
                } else {
